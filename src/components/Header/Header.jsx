            ...
            <Col xs={0} md={24}>
                <Row>
                    ...
                    <div className={clsx(gStyles.row, styles.buttons)}>
                        ...
                        <Button type="text" className={gStyles.headerButton} onClick={() => navigateTo(0.5)}>NFT</Button>
                        <Button type="text" className={gStyles.headerButton} onClick={() => navigateTo(0.8)}>Farming</Button>
